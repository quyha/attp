		...
		<?php if($list_news3!=null) $page=$list_news3->currentPage(); else $page=1; ?>
			...
			<div class="postcontent nobottommargin clearfix">
				<div id="posts" class="post-grid post-masonry clearfix">
					...
					<div class="entry clearfix">
						...
						<div class="entry-image img-list">
							<a href="{{ url(App::getLocale()) }}/{{ $url }}/{{ $rows_list_news2->c_slug }}" data-lightbox="image"><img class="image_fade" src="{{ isset($folder_img)? $folder_img.'/'.$rows_list_news2->c_img:$rows_list_news2->c_img}}" alt="{{ $rows_list_news2->c_name }}"></a>
						</div>
					...
					<div class="entry clearfix" style="width: 60%;">
						<div class="entry-image">
							<a href="{{ url(App::getLocale()) }}/{{ $url }}/{{ $list_news1->c_slug }}" data-lightbox="image"><img class="image_fade" src="{{ isset($folder_img)? $folder_img.'/'.$list_news1->c_img:$list_news1->c_img}}" alt="{{ $list_news1->c_name }}"></a>
						</div>
						<div class="entry-title">
				...
				<div id="posts" class="small-thumbs">
					...
					<div class="entry clearfix">
						<div class="entry-image">
							<a href="{{url(App::getLocale())}}/{{ $url }}/{{ $rows_list_news3->c_slug }}" data-lightbox="image"><img  src="{{ isset($folder_img)? $folder_img.'/'.$rows_list_news3->c_img:$rows_list_news3->c_img}}" alt="{{ $rows_list_news3->c_name }}"></a>
						</div>
						<div class="entry-c">
